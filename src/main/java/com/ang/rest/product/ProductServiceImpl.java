...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO update(Long id, ProductDTO productDto) {
        ...
        Category category = productDto.categoryName() != null ? categoryService.findByName(productDto.categoryName()) : existingProduct.getCategory();
    ...
    public List<ProductDTO> findAll(String filter, Page page) {
        PanacheQuery<Product> query = productRepository.findByNameIgnoreCase(filter.toLowerCase());
