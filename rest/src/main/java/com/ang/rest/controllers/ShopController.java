...
public class ShopController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Found the shop",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Found the shops",
                    content = { @Content(mediaType = "application/json",
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Shop already exists",
                content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ErrorResponse.class))            )
    })
